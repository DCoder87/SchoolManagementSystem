...
public class FeesTransactionDao implements FeesTransactionService {
    ...
    @Override
    public boolean saveFeesTransaction(FeesTransactionRequest feesTransactionRequest, String institute_id) {
        ...
        try {
            ...
            feesTransactionRepository.save(feesTransaction);
            return true;
        } catch (Exception e) {
            return false;
        }
    ...
    @Override
    public boolean updateFeesTransaction(FeesTransactionRequest feesTransactionRequest, String institute_id, int id) {
        String institute_id1 = decrypt.Decryption(institute_id);
        int i_id = Integer.parseInt(institute_id1);
	...
	public String getFeesTransactionsByFeesTransactionId(String transaction_id, String institute_id) {
		 String institute_id1 = decrypt.Decryption(institute_id);
		 String feestransaction_id = feesTransactionRepository.getFeesTransactionsByFeesTransactionId(transaction_id, institute_id1);
