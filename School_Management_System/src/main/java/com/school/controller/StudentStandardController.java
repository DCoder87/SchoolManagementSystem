...
public class StudentStandardController {
    ...
    public Map<String, Object> getStudentStandards(@PathVariable String institute_id) {
        ...
        if (allStudentStandards.isEmpty()) {
            ...
            return JsonResponses.generateResponse1(true, allStudentStandards, "Student Standards Details Get Successfully");
        }
    }
    ...
    public Map<String, Object> updateStudentStandardById(@PathVariable String institute_id,
        ...
        if (updatedStudentStandard) {
            return JsonResponses.generateResponse1(true, studentStandardRequest, "Student Standard Data Updated Successfully");
        } else {
            return JsonResponses.generateResponse1(false, studentStandard_id, "Student Standard Not Found for this ID: " + studentStandard_id);
        }
    }
    ...
    public Map<String, Object> deleteStudentStandardById(@PathVariable String institute_id,
        ...
        if (deleted == 1) {
            ...
            return JsonResponses.generateResponse2(false, "No Student Standard Found for this ID: " + studentStandard_id);
        }
    ...
    public Map<String, Object> findStudentStandardById(@PathVariable String institute_id,
        ...
        if (studentStandard.isPresent()) {
            ...
            return JsonResponses.generateResponse1(false, studentStandard_id, "Student Standard Not Found for ID: " + studentStandard_id);
        }
    }
