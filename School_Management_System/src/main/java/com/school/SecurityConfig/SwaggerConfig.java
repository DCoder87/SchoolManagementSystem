...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("School Management System - Backend",
				"This Project is Developed By Omkar for API Integration in Java Spring Boot for Inventory Management Application", "1.0",
